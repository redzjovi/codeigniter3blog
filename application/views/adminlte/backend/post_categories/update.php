	...
	<?php echo form_open(''); ?>
		...
		<div class="box-body">
			<div class="form-group">
				...
				<?php echo form_input('slug', set_value('slug', $post_category->slug), array('class' => 'form-control', 'id' => 'slug')); ?>
				<?php echo form_error('slug', '<div class="text-red">', '</div>'); ?>
			</div>
			<div class="form-group">
				<?php echo form_label(lang('name').' (*)', NULL, array('class' => 'control-label', 'for' => 'name')); ?>
				<?php echo form_input('name', set_value('name', $post_category->name), array('class' => 'form-control', 'id' => 'name')); ?>
				<?php echo form_error('name', '<div class="text-red">', '</div>'); ?>
			</div>
		</div>
		<div class="box-footer">
			<?php echo form_hidden('id', set_value('id', $post_category->id)); ?>
