	...
	<?php echo form_open_multipart(''); ?>
		...
		<div class="box-body">
			...
			<div class="form-group">
				...
				<?php echo form_input('title', set_value('title'), array('class' => 'form-control', 'id' => 'title')); ?>
			...
			<div class="form-group">
				...
				<?php echo form_textarea('content', set_value('content'), array('class' => 'form-control', 'id' => 'content')); ?>
			...
			<div class="form-group">
				...
				<?php echo img(NULL, NULL, array('id' => 'image_div', 'style' => 'width: 250px;')); ?>
			...
			<div class="form-group">
				...
				<?php echo form_dropdown('author', $data, set_value('author', $id), array('class' => 'form-control', 'id' => 'author')); ?>
			...
			<div class="form-group">
				...
				<?php echo form_dropdown('status', $data, set_value('status', '1'), array('class' => 'form-control', 'id' => 'status')); ?>
			...
			<div class="form-group">
				...
				<div class="input-group date" id="post_date_picker">
					<?php echo form_input('post_date', set_value('post_date', date($datetime_php)), array('class' => 'form-control', 'id' => 'post_date')); ?>
